...
La aplicación está conformada por un menú principal (archivo menú_inicio.py), donde se puede seleccionar la opción que desea realizar el usuario. Cada opción tiene creada su función de modularización (menú_reserva.py y menú_usuario.py) donde se realizaran todas las acciones que corresponden a la misma.
